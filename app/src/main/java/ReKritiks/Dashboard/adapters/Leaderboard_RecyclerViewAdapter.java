...
{
    Context mContext;
    List<Leaderboard_Contact> mData;



    public Leaderboard_RecyclerViewAdapter(Context context, List<Leaderboard_Contact> lstLeaderboardContact) {
        this.mContext = context;
        this.mData = lstLeaderboardContact;
    }
